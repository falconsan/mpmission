...
DefaultMagazines = ["ItemBandage","ItemBandage","FoodCanBakedBeans","ItemSodaPepsi","ItemPainkiller","ItemMorphine"];
DefaultWeapons = ["ItemMachete","ItemMap","ItemCompass"];
